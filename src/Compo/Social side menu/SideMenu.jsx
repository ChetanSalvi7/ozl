  ...
  return (
    ...
    <aside className="sticky-contact-bar">
        <nav>
            ...
            <NavLink title="Visit us" data-bs-toggle="tooltip" data-bs-placement="right" to="/"  ><i className="fa-solid fa-location-dot"></i></NavLink>
            <NavLink title="Contact us" data-bs-toggle="tooltip" data-bs-placement="right" to="/" ><i className="fa-solid fa-envelope"></i></NavLink>
        </nav>
    </aside>
    {/* <!-- / Sidebar Social Menu --> */}
