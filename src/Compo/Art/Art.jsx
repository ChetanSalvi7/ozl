...
const Art = () => {
    ...
    const Data1 =[{id:2,name:'Museum standard storage',Logo: `${LogoUrl+LogoBox[0].PngLogo1}`},
        {id:3,name:'Allocated vaults/ studios available',Logo: `${LogoUrl+LogoBox[1].PngLogo2}`},
        {id:4,name:'Domestic & customs warehousing',Logo: `${LogoUrl+LogoBox[2].PngLogo3}`},
        {id:5,name:'High Security Standards',Logo: `${LogoUrl+LogoBox[3].PngLogo4}`},
        {id:6,name:'Global professional logistics',Logo: `${LogoUrl+LogoBox[4].PngLogo5}`},
        {id:7,name:'Handling by renowned partners',Logo: `${LogoUrl+LogoBox[5].PngLogo6}`},
        {id:8,name:'Multiple locations in Liechtenstein',Logo: `${LogoUrl+LogoBox[6].PngLogo7}`},
        {id:9,name:'GRASP-certified storage',Logo: `${LogoUrl+LogoBox[7].PngLogo8}`}];

    const Data2 = [{id:12,dataname: 'Optimum solutions via renowned partners',images: `${LogoUrl+ImageBox[0].logo1}`},
        {id:13,dataname: 'State-of-the-art professional logistics infrastructure/Security and efficiency',images: `${LogoUrl+ImageBox[1].logo2}`},
        {id:14,dataname: 'Global transportation of precious metals, art, and other valuables, including customs clearance',images: `${LogoUrl+ImageBox[2].logo3}`},
        {id:15,dataname: 'International logistics within transit zones/Own customs specialists',images: `${LogoUrl+ImageBox[3].logo4}`},
        {id:16,dataname: 'Global logistics and storage',images: `${LogoUrl+ImageBox[4].logo5}`},
        {id:17,dataname: 'Full logistics service, from collection to delivery / All from a single source',images: `${LogoUrl+ImageBox[5].logo6}`},
        {id:18,dataname: 'International security transportats',images: `${LogoUrl+ImageBox[6].logo7}`},
        {id:19,dataname: 'Worldwide customs clearance',images: `${LogoUrl+ImageBox[7].logo8}`},
        {id:20,dataname: 'Door to Door insurance coverage',images: `${LogoUrl+ImageBox[8].logo9}`}];
    return (
        <>
        {/* Banner--start*/}
