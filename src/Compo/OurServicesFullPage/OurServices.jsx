        ...
        <div className="row align-items-start">
            ...
            <div className="col-md-10 tab-content" id="v-pills-tabContent">
                <div className={`tab-pane fade  ps-md-5 py-md-4 py-3 ${locationUrlHash == '#custody' || locationUrlHash == '' ? ' active show': ''} `} id="custody" role="tabpanel">
                    ...
                    <a href="https://www.ozl.li/fileadmin//user_upload/OZL_Regulierung_EN.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white" role="button">PDF</a>
                </div>
                ...
                <div className={`tab-pane fade  ps-md-5 py-md-4 py-3 ${locationUrlHash == '#allrisk' ? ' active show': ''} `} id="allrisk" role="tabpanel">
                    ...
                    <p><strong>For further question please contact us.</strong></p>
                    <a href="https://www.ozl.li/fileadmin//user_upload/OZL_Versicherung_EN.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white" role="button">PDF</a>
                </div>
                ...
                <div className={`tab-pane fade  ps-md-5 py-md-4 py-3 ${locationUrlHash == '#bankable' ? ' active show': ''} `} id="bankable" role="tabpanel">
                    ...
                    <div className="d-flex align-items-center">
                        <a href="https://www.ozl.li/fileadmin//user_upload/OZL_Reporte_EN.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white me-3" role="button">FACTSHEET REPORT (PDF)</a>
                        <a href="https://www.ozl.li/fileadmin//user_upload/Stock_Report.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white" role="button">STOCK REPORT (PDF)</a>
                    </div>
                </div>
                ...
                <div className={`tab-pane fade  ps-md-5 py-md-4 py-3 ${locationUrlHash == '#segregated' ? ' active show': ''} `} id="segregated" role="tabpanel">
                    ...
                    <a href="https://www.ozl.li/fileadmin//user_upload/OZL_Einzelverwahrung_EN.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white" role="button">PDF</a>
                </div>
                ...
                <div className={`tab-pane fade  ps-md-5 py-md-4 py-3 ${locationUrlHash == '#fees' ? ' active show': ''} `} id="fees" role="tabpanel">
                    <div className="d-flex align-items-center">
                        <a href="https://www.ozl.li/fileadmin//user_upload/OZL_Preisliste_01072021_EN_neu.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white me-3" role="button">ALLOCATED CUSTODY PRECIOUS METALS (PDF)</a>
                        <a href="https://www.ozl.li/fileadmin//user_upload/OZL_Preisliste_EV__DE_-Diamanten_EN.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white me-3" role="button">ALLOCATED CUSTODY DIAMONDS (PDF)</a>
                        <a href="https://www.ozl.li/fileadmin//user_upload/Preisliste_2021_EN__neu.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white" role="button">SAFE DEPOSIT BOXES AND VAULTS (PDF)</a>
                    </div>
                </div>
                ...
                <div className={`tab-pane fade  ps-md-5 py-md-4 py-3 ${locationUrlHash == '#conratats' ? ' active show': ''} `} id="conratats" role="tabpanel">
                    <div className="d-flex align-items-center">
                        <a href="https://www.ozl.li/fileadmin//user_upload/Verwahrvertrag_OZL_de_en.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white me-3" role="button">CUSTODY AGREEMENT (PDF)</a>
                        <a href="https://www.ozl.li/fileadmin//user_upload/Mietvertrag_OZL_de_en.pdf" target='_blank' className="btn btn-lg btn-primary px-5 py-3 text-white" role="button">RENTAL AGREEMENT (PDF)</a>
                    </div>
                </div>
            </div>
        </div>
