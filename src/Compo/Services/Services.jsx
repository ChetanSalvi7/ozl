    ...
    <section className="py-3 py-lg-5">
        <div className="container-xxl px-lg-5">
          ...
          <div className="service-grid">
            <NavLink to='/ourservices' className="service service-grid-1">
            ...
            <NavLink to='/ourservices' className="service service-grid-2">
            ...
            <NavLink to='/ourservices' className="service service-grid-3">
            ...
            <NavLink to='/ourservices' className="service service-grid-5">
